...
const CONTACT_INFO = [
  {
    icon: MapPin,
    title: 'Our Address',
    details: 'Arif Malik & Sons - Oxford Corner, Kharadar',
        ...
        <FadeInWhenVisible>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Located in Karachi, ready to serve your heavy equipment transport needs
            </p>
          </div>
        </FadeInWhenVisible>
          ...
          <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-gray-100">
                ...
                <div className="space-y-5">
                  {CONTACT_INFO.map((info, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-4 p-4 rounded-lg hover:bg-orange-50 transition-colors duration-300 group"
                    >
                      <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-orange-600 transition-colors duration-300">
                        <info.icon className="w-6 h-6 text-orange-600 group-hover:text-white transition-colors duration-300" />
                      </div>
            ...
            <FadeInWhenVisible delay={300}>
              <a
                ...
                className="flex items-center justify-center gap-3 w-full bg-orange-600 text-white px-6 py-4 rounded-lg font-semibold hover:bg-orange-700 transition-colors duration-300 shadow-lg hover:shadow-xl hover:active:scale-95"
              >
          ...
          <FadeInWhenVisible delay={400}>
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border-2 border-gray-100 h-full min-h-[500px]">
              <iframe
                ...
                title="Arif Malik & Sons Location"
              ></iframe>
            </div>
          </FadeInWhenVisible>
