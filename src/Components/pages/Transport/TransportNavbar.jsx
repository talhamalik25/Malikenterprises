...
const NAV_LINKS = [
  { id: 'home', name: 'Home', path: '#herosection' },
  { id: 'services', name: 'Services', path: '#service' },
...
const TransportNavbar = () => {
  ...
  return (
    ...
    >
      {/* Top Info Bar */}
      <div className="bg-orange-600 py-2.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between text-white text-sm">
            ...
            <div className="text-sm font-medium">
              Heavy Equipment Transport Specialists
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <button 
                  ...
                  className='text-xl font-bold text-slate-900 hover:text-orange-600 transition-colors'
                >
                  Arif Malik & Sons
                </button>
                <p className="text-xs text-gray-600 font-medium">Logistics</p>
              </div>
            </div>
          </div>
            ...
            {NAV_LINKS.map((link) => (
              link.isExternal ? (
                <Link
                  key={link.id}
                  to={link.path}
                  className="text-base font-semibold transition-all duration-300 text-gray-700 hover:text-orange-600"
                >
                  {link.name}
                </Link>
              ) : (
          ...
          <div className="hidden lg:flex items-center gap-2">
            <button 
              ...
              className="bg-orange-600 text-white px-6 py-3 font-semibold rounded-md hover:bg-orange-700 transition-colors duration-300 shadow-md hover:shadow-lg"
            >
              Get Quote
            </button>
          </div>
      ...
      >
        <div className="bg-white px-4 py-6 space-y-2">
          {NAV_LINKS.map((link) => (
            link.isExternal ? (
              <Link
                ...
                className="block w-full text-left px-4 py-3 rounded-md font-semibold transition-all duration-300 text-gray-700 hover:text-orange-600 hover:bg-gray-50"
              >
                {link.name}
              </Link>
            ) : (
          ...
          <button
            ...
            className='w-full px-6 py-3 bg-orange-600 text-white font-semibold rounded-md hover:bg-orange-700 transition-colors duration-300 mt-4 shadow-md'
          >
            Request Quote
          </button>
        </div>
